...
const Footer = () => {
  ...
  return (
    <footer>
          ...
          <div className="grid lg:grid-cols-4 sm:grid-cols-1 gap-6">
            <div className="sm:col-span-2">
              ...
              <p className="text-base text-white">
                ...
                harmonies, and perfecting your rhythm. Join our vibrant
                community of music enthusiasts and embark on a transformative
                musical journey. Let the notes guide you at Note Nexus
              </p>
      ...
      <div className={` ${darkMode ? "bg-gray-800" : "bg-[#0a3f55]"} py-4`}>
